...
<div style="width: 100%;">
  ...
  <img style="width: 100%; max-width:" src="https://northwest.cdc.gov.sg/images/Cohesion/May%202023/interfaith-adventures-title.png">
</div>
...
<h2 style="color: #D5262B; font-weight: bold !important; font-size: x-large;">
  <strong>An Eye-Opening Interfaith Journey  </strong>
</h2>
</div>
...
<h2 style="color: #D5262B; font-weight: bold !important; font-size: x-large;">
  <strong>My visit to BW Monastery in pictures </strong>
</h2>
</div>

<div class="rounded20" style="max-width: 100%; padding: 20px 0px;">
  <img style="width: 100%; margin-top: 0px;" class="rounded20" src="https://northwest.cdc.gov.sg/images/Cohesion/May%202023/fun-facts%20pic.png">
</div>
...
<div style="width: 100%; background: #F5E1E0; padding: 0px 0px 0px;" class="rounded20">
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      <p style="font-size: 20px; font-weight: bold; text-align: left; color: #D5262B; margin: 0px 0px;"><strong>Be part of an enriching experience</strong>
      </p> 
        <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px;"><a style="font-weight: bold; color: #D5262B;" target="_new" href="https://northwest.cdc.gov.sg/programmes/advocating-green-living/north-west-sustainability-forum/">Interfaith @ North West</a> works with faith institutions to organise open houses so the community can learn about and appreciate each other’s faiths. The programme aims to strengthen racial and religious harmony in our community.</p>
        <p style="font-size: 16px; text-align: left; line-height: 24px; color: #000; margin: 10px 0px;">Curious to learn more about different faiths in Singapore and to engage in meaningful discussions with people from diverse backgrounds? Join us for our next interfaith dialogue.</p>  
  </div>
</div>
</div>
</div>
...
<h2 style="color: #D5262B; font-weight: bold !important; font-size: x-large;">
  <strong>Learn more about the programme here:</strong>
</h2>
</div>

<div class="video-container rounded20">
  <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" frameborder="0" title="North West CDC Mayor Message" src="https://www.youtube.com/embed/rke2StZwfHs"></iframe>
</div>
