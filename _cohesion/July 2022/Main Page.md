...
                <a href="mailto:northwest\_cdc@pa.gov.sg" target="\_new" style="background: #ea5e1f; color: #FFFFFF; -webkit-border-radius: 50px; -moz-border-radius: 50px; border-radius: 50px; font-weight: bold; text-transform: uppercase; padding: 13px 20px; text-decoration: none; font-size: medium;">Tell Us More</a>  
