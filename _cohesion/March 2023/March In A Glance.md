...
Ever wonder what CDC does, and how different are we from the Town Councils and CCs? Here are some facts and myths you ought to find out!  
</p>
...
<div style="max-width: 740px; margin: 0px auto; padding: 60px 22px;">
<div style="width: 100%; background: #fdddce; padding: 10px 0px 40px; text-align: center; -webkit-border-radius: 30px; -moz-border-radius: 30px; border-radius: 30px;">
  ...
  <div style="padding: 5px 25px; text-align: center; max-width: 500px; margin: auto;">
    <p>Get ready to move, sweat, and win! Join our 3 Months Stay Active Contest on IG and stand a chance to win F&B E-vouchers.  So why wait? Start advocating for healthy living and an active lifestyle today!</p>
  </div>
  <a href="#" target="_new">
    <img src="https://d33wubrfki0l68.cloudfront.net/404ca3f2f9bda14a573964d1b5e9ea59721d7dbc/eb509/images/edm_36b.jpg" style="max-width: 100%; max-height: 52px;">
  </a>
  ...
  <div style="padding: 5px 30px; text-align: center; max-width: 500px; margin: auto;">
    <p>Be inspired by stories of remarkable women from all walks of life! In&nbsp;honour of International's Women's Day, here are some incredible women volunteers who have stepped forward to make a positive impact in the North West community.</p>
  </div>
  <a href="#" target="_new">
    <img src="/images/Cohesion/March%202023/stay-posted-5.jpg" style="max-width: 100%; max-height: 55px;">
  </a>
