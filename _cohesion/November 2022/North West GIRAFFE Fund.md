...
<h2 style="color: #D5262B; font-weight: bold; font-size: x-large;">
  <strong>SHWAP for Sustainability</strong>
</h2>
</div>
    ...
    <div class="slider__slides">
      <div class="slider__slide slider__slide--1">
                <div style="width:  100%; text-align: center; margin: 0; position: absolute; top: 50%; transform: translateY(-50%);">
                  <p class="slide-txt"><em>Our main motivation in participating in this event was to encourage students and residents to cultivate green habits through reducing textile waste as we encourage sustainable fashion through clothes redistribution events. Reusing clothes will also facilitate a circular economy so as to reduce the volume of waste entering into the landfill.</em></p>
                <p style="font-size: 15px; line-height: initial; margin-top: 0px; color: #FFFFFF;"><em>-Ignacio Dara Janina Jacinto and B. Monisha D/O Vn Balamurugan<br/> 
President and Secretary of Conservation Interest Group<br/>
Republic Polytechnic, Diploma in Environmental and Marine Science</em></p>
                </div>
      </div>
    </div>
  </div>
