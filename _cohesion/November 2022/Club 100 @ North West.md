...
<div style="width: 100%; background: #fef2fd; border-radius: 30px; padding: 20px 0px;">
  ...
  <h2 style="color: #D5262B; font-weight: bold; font-size: x-large;">
    <strong>Make a difference in the community </strong>
  </h2>
  <p style="font-size: 16px; line-height: 26px;">If you'd like to be involved in uplifting the community, be a Club-100 @ North West member today. Your generosity will be truly appreciated as you share the gift of love with needy households. Find out how you can start making a difference to the lives of others <a href="https://go.gov.sg/c100nw" target="_new" style="color: #D5262B;">here</a>.</p> 
  </div>
</div>
</div>
