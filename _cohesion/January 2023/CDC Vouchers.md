...
<div>
	<img style="width: 100%; margin-top: 0px;" src="images/Cohesion/Jan%202023/vouchers-kv.png">
</div>
...
<div style="width: 100%; background: #F2F8F6; padding: 20px 0px 0px;" class="rounded20">
  <div style="padding: 10px 40px;">

  <div>
    <p style="color: #D5262B; font-weight: bold; font-size: x-large;">
      <img align="left" style="max-width: 40px; margin: -8px 10px 0px 0px; float: left;" src="https://d33wubrfki0l68.cloudfront.net/b418db455e809024f12a7cff20a59dda28d0f83a/6d6b7/images/cdc_icon1.png"><strong>Stock up on CNY goodies</strong>
    </p>
  </div>
...
<!--Box-->
<div style="padding: 20px 0px 0px;">
<div style="width: 100%; background: #D7E9E4; padding: 20px 0px 0px;" class="rounded20">
  <div style="padding: 10px 40px;">

  <div>
    <p style="color: #D5262B; font-weight: bold; font-size: x-large;">
      <img align="left" style="max-width: 40px; margin: -8px 10px 0px 0px; float: left;" src="https://d33wubrfki0l68.cloudfront.net/c328da1e881761758731e092d3447d09f99c25c6/fbb63/images/cdc_icon2.png"><strong>Prepare for the reunion dinner</strong>
    </p>
  </div>
...
Planning the menu for your reunion dinner this year?  You can add more ingredients to your grocery list and make the most out of your budget with the CDC Vouchers!   
  ...
  <p style="font-size: 16px; line-height: 26px;">
      ...
      <li style="line-height: 30px; padding-bottom: 15px;">
        <strong style="text-transform: uppercase;">FORTUNE SUPERMARKET PTE LTD - Blk 780 Woodlands Crescent</strong><br> 
        Woodlands Crescent, #01-01, S730780
      </li>
      <li style="line-height: 30px; padding-bottom: 15px;">
...
<div style="width: 100%; background: #F2F8F6; padding: 20px 0px 0px;" class="rounded20">
  ...
  <div>
    <p style="color: #D5262B; font-weight: bold; font-size: x-large;">
      <img align="left" style="max-width: 40px; margin: -8px 10px 0px 0px; float: left;" src="https://d33wubrfki0l68.cloudfront.net/9c1bf2a550606c41ae2076e2c4ba5d60c932216d/5e56f/images/cdc_icon3.png"><strong>Update your wardrobe</strong>
    </p>
  </div>
...
<div style="width: 100%; background: #D7E9E4; padding: 20px 0px 0px;" class="rounded20">
  ...
  <div>
    <p style="color: #D5262B; font-weight: bold; font-size: x-large;">
      <img align="left" style="max-width: 40px; margin: -8px 10px 0px 0px; float: left;" src="https://d33wubrfki0l68.cloudfront.net/1ab3c0d6224b762b49a17faf1f9dd160126a1dac/1aff4/images/cdc_icon4.png"><strong>Get a new year makeover</strong>
    </p>
  </div>
...
<div style="width: 100%; background: #F2F8F6; padding: 20px 0px 0px;" class="rounded20">
  ...
  <div>
    <p style="color: #D5262B; font-weight: bold; font-size: x-large;">
      <img align="left" style="max-width: 40px; margin: -8px 10px 0px 0px; float: left;" src="https://d33wubrfki0l68.cloudfront.net/12160d66576acc0784257dcabf20a7118bcd0320/cb377/images/cdc_icon5.png"><strong>Spruce up your home</strong>
    </p>
  </div>
...
<div class="video-container">
  <iframe allowfullscreen="" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" frameborder="0" title="YouTube video player" src="https://www.youtube.com/embed/UyvUvKO3j0g"></iframe>
</div>
</div>
  ...
  <div style="padding: 30px 40px;">
    <div style="padding: 0px 0px;">
      <p style="font-size: 18px; text-align: left; color: #0C6C37; margin: 0px 0px;"><strong>Ready to start CNY shopping with your CDC vouchers? </strong>
        ...
        <p style="font-size: 16px; text-align: left; line-height: initial; color: #000; margin: 10px 0px;">To claim your CDC vouchers, visit <a style="color: #0C6C37; text-decoration: underline; font-weight: bold;" target="_new" href="https://go.gov.sg/cdcv">go.gov.sg/cdcv</a><br>
To find out where you can spend your CDC vouchers, visit <a style="color: #0C6C37; text-decoration: underline; font-weight: bold;" target="_new" href="https://gowhere.gov.sg/cdcvouchersmerchants">gowhere.gov.sg/cdcvouchersmerchants</a> </p>  
    </div>
  </div>
</div>
</div>
